...
namespace comdeeds
{
    public partial class RA53_Asic : System.Web.UI.Page
    {
        // Certificate and key
        ...
        private static string s_version = "99999";
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           // {
                try
                {
                    ...
                    s_version = ConfigurationManager.AppSettings["version"].ToString();

                    s_certificateFileName = @"ComDeeds.pem";
                    //s_certificateFileName = @"old.key";
                    s_certificateFileName = Server.MapPath(s_certificateFileName);


                    // Load the certificate into an X509Certificate object.
                    //X509Certificate2 cert = X509Certificate2.CreateFromCertFile(s_certificateFileName, "", X509KeyStorageFlags.Exportable);
                    // X509Certificate2 cert = new X509Certificate2(s_certificateFileName, "", X509KeyStorageFlags.Exportable);
                    // Get the value.
        ...
        private void Step2ASelfSignCertificateRA53(EDGETransport edgeTransportLayer)
        {
            ...
            if (true)
            {
                ...
                TXID txid = new TXID((""), s_version, "1", 1, s_agentNumber, false, true, certificate, x509);
        ...
        #endregion
        protected void btnra53_Click(object sender, EventArgs e)
        {
        ...
        private void SaveRa53SentData(string fileContent)
        {
            try
            {
                string fileName = "C:/asicfiles/Logs/" + "Ra53Sent" + DateTime.Now.Second + "_" + DateTime.Now.Minute + ".txt";
