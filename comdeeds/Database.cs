...
//     Connection String:      "Data Source=DSYS-PC;Initial Catalog=comdeed;Integrated Security=True"
// ------------------------------------------------------------------------------------------------
...
namespace comdeeds
{
    ...
    public interface IMyDbContext : System.IDisposable
    {
        ...
        System.Collections.Generic.List<GetRegistrationReturnModel> GetRegistration(string email);
        System.Collections.Generic.List<GetRegistrationReturnModel> GetRegistration(string email, out int procResult);
        System.Threading.Tasks.Task<System.Collections.Generic.List<GetRegistrationReturnModel>> GetRegistrationAsync(string email);
        ...
        System.Collections.Generic.List<GetAdminTrustListReturnModel> GetAdminTrustList(int? startLength, int? length, string orderBy, out int? pageCount);
        System.Collections.Generic.List<GetAdminTrustListReturnModel> GetAdminTrustList(int? startLength, int? length, string orderBy, out int? pageCount, out int procResult);
        // GetAdminTrustListAsync cannot be created due to having out parameters, or is relying on the procedure result (System.Collections.Generic.List<GetAdminTrustListReturnModel>)
        ...
        System.Collections.Generic.List<GetPaymentListReturnModel> GetPaymentList(int? startLength, int? length, string orderBy, out int? pageCount);
        System.Collections.Generic.List<GetPaymentListReturnModel> GetPaymentList(int? startLength, int? length, string orderBy, out int? pageCount, out int procResult);
        // GetPaymentListAsync cannot be created due to having out parameters, or is relying on the procedure result (System.Collections.Generic.List<GetPaymentListReturnModel>)
        ...
        System.Collections.Generic.List<SpInsertCompanysearchReturnModel> SpInsertCompanysearch(string userid, string companyname);
        System.Collections.Generic.List<SpInsertCompanysearchReturnModel> SpInsertCompanysearch(string userid, string companyname, out int procResult);
        System.Threading.Tasks.Task<System.Collections.Generic.List<SpInsertCompanysearchReturnModel>> SpInsertCompanysearchAsync(string userid, string companyname);
        ...
        int UpdateStep4Anothershareholder(int? step4Id, string companyid, string shareholderdetails, string shareclasstypeValue, string shareclasstypeText, int? noOfShares, decimal? amountpaidpershare, decimal? amountremainingunpaidpershare, string isheldanotherorg, string beneficialownername, string individualOrCompany, string individualOrCompanyName, string individualOrCompanyAcn, string individualOrCompanyAddress, string individualOrCompanyDob, string individualOrCompanyUnitLevelSuite, string individualOrCompanyStreetNoName, string individualOrCompanySuburbTownCity, string individualOrCompanyState, string individualOrCompanyPostcode, string individualOrCompanyCountry, string individualOrCompanyJoint, string individualOrCompanyNameJoint, string individualOrCompanyAcnJoint, string individualOrCompanyAddressJoint, string individualOrCompanyDobJoint, string individualOrCompanyUnitLevelSuiteJoint, string individualOrCompanyStreetNoNameJoint, string individualOrCompanySuburbTownCityJoint, string individualOrCompanyStateJoint, string individualOrCompanyPostcodeJoint, string individualOrCompanyCountryJoint, string isjoint, int? dirid, int? id);
        ...
        System.Collections.Generic.List<UpdatecompanyOptionReturnModel> UpdatecompanyOption(long? cid, bool? quotefortax, bool? legelassessment, bool? borrowing, bool? agreement, long? uid);
        System.Collections.Generic.List<UpdatecompanyOptionReturnModel> UpdatecompanyOption(long? cid, bool? quotefortax, bool? legelassessment, bool? borrowing, bool? agreement, long? uid, out int procResult);
        System.Threading.Tasks.Task<System.Collections.Generic.List<UpdatecompanyOptionReturnModel>> UpdatecompanyOptionAsync(long? cid, bool? quotefortax, bool? legelassessment, bool? borrowing, bool? agreement, long? uid);

        System.Collections.Generic.List<UpdatetrustReturnModel> Updatetrust(long? id, string name, string type, System.DateTime? setupDate, string state, string smsf, string acn, string abn, string ptn, string padd, string lname, long? uid, string smsfCompanyName, string smsfAcn, System.DateTime? smsfCompanySetupDate, System.DateTime? propertyTrusteeDate);
        System.Collections.Generic.List<UpdatetrustReturnModel> Updatetrust(long? id, string name, string type, System.DateTime? setupDate, string state, string smsf, string acn, string abn, string ptn, string padd, string lname, long? uid, string smsfCompanyName, string smsfAcn, System.DateTime? smsfCompanySetupDate, System.DateTime? propertyTrusteeDate, out int procResult);
        ...
        System.Collections.Generic.List<UserloginReturnModel> Userlogin(string email, string pass);
        System.Collections.Generic.List<UserloginReturnModel> Userlogin(string email, string pass, out int procResult);
        System.Threading.Tasks.Task<System.Collections.Generic.List<UserloginReturnModel>> UserloginAsync(string email, string pass);
    ...
    public class MyDbContext : System.Data.Entity.DbContext, IMyDbContext
    {
        ...
        public System.Collections.Generic.List<GetRegistrationReturnModel> GetRegistration(string email)
        {
            int procResult;
            return GetRegistration(email, out procResult);
        }

        public System.Collections.Generic.List<GetRegistrationReturnModel> GetRegistration(string email, out int procResult)
        {
            ...
            var procResultParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@procResult", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output };
            var procResultData = Database.SqlQuery<GetRegistrationReturnModel>("EXEC @procResult = [dbo].[get_registration] @email", emailParam, procResultParam).ToList();

            procResult = (int)procResultParam.Value;
            return procResultData;
        }

        public async System.Threading.Tasks.Task<System.Collections.Generic.List<GetRegistrationReturnModel>> GetRegistrationAsync(string email)
        {
            var emailParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@email", SqlDbType = System.Data.SqlDbType.VarChar, Direction = System.Data.ParameterDirection.Input, Value = email, Size = 100 };
            if (emailParam.Value == null)
                emailParam.Value = System.DBNull.Value;

            var procResultData = await Database.SqlQuery<GetRegistrationReturnModel>("EXEC [dbo].[get_registration] @email", emailParam).ToListAsync();
        ...
        public System.Collections.Generic.List<GetAdminTrustListReturnModel> GetAdminTrustList(int? startLength, int? length, string orderBy, out int? pageCount)
        {
            int procResult;
            return GetAdminTrustList(startLength, length, orderBy, out pageCount, out procResult);
        }

        public System.Collections.Generic.List<GetAdminTrustListReturnModel> GetAdminTrustList(int? startLength, int? length, string orderBy, out int? pageCount, out int procResult)
        {
            var startLengthParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@startLength", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Input, Value = startLength.GetValueOrDefault(), Precision = 10, Scale = 0 };
            if (!startLength.HasValue)
                startLengthParam.Value = System.DBNull.Value;
            ...
            var pageCountParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@PageCount", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output, Precision = 10, Scale = 0 };
            var procResultParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@procResult", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output };
            var procResultData = Database.SqlQuery<GetAdminTrustListReturnModel>("EXEC @procResult = [dbo].[getAdminTrustList] @startLength, @length, @orderBy, @PageCount OUTPUT", startLengthParam, lengthParam, orderByParam, pageCountParam, procResultParam).ToList();
            if (IsSqlParameterNull(pageCountParam))
                pageCount = null;
            else
                pageCount = (int)pageCountParam.Value;
        ...
        public System.Collections.Generic.List<GetPaymentListReturnModel> GetPaymentList(int? startLength, int? length, string orderBy, out int? pageCount)
        {
            int procResult;
            return GetPaymentList(startLength, length, orderBy, out pageCount, out procResult);
        }

        public System.Collections.Generic.List<GetPaymentListReturnModel> GetPaymentList(int? startLength, int? length, string orderBy, out int? pageCount, out int procResult)
        {
            var startLengthParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@startLength", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Input, Value = startLength.GetValueOrDefault(), Precision = 10, Scale = 0 };
            if (!startLength.HasValue)
                startLengthParam.Value = System.DBNull.Value;
            ...
            var pageCountParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@PageCount", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output, Precision = 10, Scale = 0 };
            var procResultParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@procResult", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output };
            var procResultData = Database.SqlQuery<GetPaymentListReturnModel>("EXEC @procResult = [dbo].[getPaymentList] @startLength, @length, @orderBy, @PageCount OUTPUT", startLengthParam, lengthParam, orderByParam, pageCountParam, procResultParam).ToList();
            if (IsSqlParameterNull(pageCountParam))
                pageCount = null;
            else
                pageCount = (int)pageCountParam.Value;
        ...
        public System.Collections.Generic.List<SpInsertCompanysearchReturnModel> SpInsertCompanysearch(string userid, string companyname)
        {
            int procResult;
            return SpInsertCompanysearch(userid, companyname, out procResult);
        }

        public System.Collections.Generic.List<SpInsertCompanysearchReturnModel> SpInsertCompanysearch(string userid, string companyname, out int procResult)
        {
            ...
            var procResultParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@procResult", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output };
            var procResultData = Database.SqlQuery<SpInsertCompanysearchReturnModel>("EXEC @procResult = [dbo].[sp_insert_companysearch] @userid, @companyname", useridParam, companynameParam, procResultParam).ToList();

            procResult = (int)procResultParam.Value;
            return procResultData;
        }

        public async System.Threading.Tasks.Task<System.Collections.Generic.List<SpInsertCompanysearchReturnModel>> SpInsertCompanysearchAsync(string userid, string companyname)
        {
            var useridParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@userid", SqlDbType = System.Data.SqlDbType.VarChar, Direction = System.Data.ParameterDirection.Input, Value = userid, Size = 50 };
            if (useridParam.Value == null)
                useridParam.Value = System.DBNull.Value;
            ...
            var procResultData = await Database.SqlQuery<SpInsertCompanysearchReturnModel>("EXEC [dbo].[sp_insert_companysearch] @userid, @companyname", useridParam, companynameParam).ToListAsync();
        ...
        public System.Collections.Generic.List<UpdatecompanyOptionReturnModel> UpdatecompanyOption(long? cid, bool? quotefortax, bool? legelassessment, bool? borrowing, bool? agreement, long? uid)
        {
            int procResult;
            return UpdatecompanyOption(cid, quotefortax, legelassessment, borrowing, agreement, uid, out procResult);
        }

        public System.Collections.Generic.List<UpdatecompanyOptionReturnModel> UpdatecompanyOption(long? cid, bool? quotefortax, bool? legelassessment, bool? borrowing, bool? agreement, long? uid, out int procResult)
        {
            var cidParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@cid", SqlDbType = System.Data.SqlDbType.BigInt, Direction = System.Data.ParameterDirection.Input, Value = cid.GetValueOrDefault(), Precision = 19, Scale = 0 };
            if (!cid.HasValue)
                cidParam.Value = System.DBNull.Value;
            ...
            var procResultParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@procResult", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output };
            var procResultData = Database.SqlQuery<UpdatecompanyOptionReturnModel>("EXEC @procResult = [dbo].[updatecompanyOption] @cid, @quotefortax, @legelassessment, @borrowing, @agreement, @uid", cidParam, quotefortaxParam, legelassessmentParam, borrowingParam, agreementParam, uidParam, procResultParam).ToList();

            procResult = (int)procResultParam.Value;
            return procResultData;
        }

        public async System.Threading.Tasks.Task<System.Collections.Generic.List<UpdatecompanyOptionReturnModel>> UpdatecompanyOptionAsync(long? cid, bool? quotefortax, bool? legelassessment, bool? borrowing, bool? agreement, long? uid)
        {
            var cidParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@cid", SqlDbType = System.Data.SqlDbType.BigInt, Direction = System.Data.ParameterDirection.Input, Value = cid.GetValueOrDefault(), Precision = 19, Scale = 0 };
            if (!cid.HasValue)
                cidParam.Value = System.DBNull.Value;
            ...
            var procResultData = await Database.SqlQuery<UpdatecompanyOptionReturnModel>("EXEC [dbo].[updatecompanyOption] @cid, @quotefortax, @legelassessment, @borrowing, @agreement, @uid", cidParam, quotefortaxParam, legelassessmentParam, borrowingParam, agreementParam, uidParam).ToListAsync();
        ...
        {
            int procResult;
            return Updatetrust(id, name, type, setupDate, state, smsf, acn, abn, ptn, padd, lname, uid, smsfCompanyName, smsfAcn, smsfCompanySetupDate, propertyTrusteeDate, out procResult);
        }
        ...
        public System.Collections.Generic.List<UserloginReturnModel> Userlogin(string email, string pass)
        {
            int procResult;
            return Userlogin(email, pass, out procResult);
        }

        public System.Collections.Generic.List<UserloginReturnModel> Userlogin(string email, string pass, out int procResult)
        {
            ...
            var procResultParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@procResult", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output };
            var procResultData = Database.SqlQuery<UserloginReturnModel>("EXEC @procResult = [dbo].[userlogin] @email, @pass", emailParam, passParam, procResultParam).ToList();

            procResult = (int)procResultParam.Value;
            return procResultData;
        }

        public async System.Threading.Tasks.Task<System.Collections.Generic.List<UserloginReturnModel>> UserloginAsync(string email, string pass)
        {
            var emailParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@email", SqlDbType = System.Data.SqlDbType.NVarChar, Direction = System.Data.ParameterDirection.Input, Value = email, Size = 2000 };
            if (emailParam.Value == null)
                emailParam.Value = System.DBNull.Value;
            ...
            var procResultData = await Database.SqlQuery<UserloginReturnModel>("EXEC [dbo].[userlogin] @email, @pass", emailParam, passParam).ToListAsync();
    ...
    public class FakeMyDbContext : IMyDbContext
    {
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.List<GetRegistrationReturnModel>> GetRegistrationAsync(string email)
        {
            int procResult;
            return System.Threading.Tasks.Task.FromResult(GetRegistration(email, out procResult));
        }
        ...
        public System.Collections.Generic.List<GetAdminTrustListReturnModel> GetAdminTrustList(int? startLength, int? length, string orderBy, out int? pageCount, out int procResult)
        {
            ...
            procResult = 0;
            return new System.Collections.Generic.List<GetAdminTrustListReturnModel>();
        }
        ...
        public System.Collections.Generic.List<GetPaymentListReturnModel> GetPaymentList(int? startLength, int? length, string orderBy, out int? pageCount, out int procResult)
        {
            ...
            procResult = 0;
            return new System.Collections.Generic.List<GetPaymentListReturnModel>();
        }
        ...
        public System.Collections.Generic.List<SpInsertCompanysearchReturnModel> SpInsertCompanysearch(string userid, string companyname, out int procResult)
        {
            ...
            procResult = 0;
            return new System.Collections.Generic.List<SpInsertCompanysearchReturnModel>();
        }

        public System.Threading.Tasks.Task<System.Collections.Generic.List<SpInsertCompanysearchReturnModel>> SpInsertCompanysearchAsync(string userid, string companyname)
        {
            int procResult;
            return System.Threading.Tasks.Task.FromResult(SpInsertCompanysearch(userid, companyname, out procResult));
        }
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.List<UpdatecompanyOptionReturnModel>> UpdatecompanyOptionAsync(long? cid, bool? quotefortax, bool? legelassessment, bool? borrowing, bool? agreement, long? uid)
        {
            int procResult;
            return System.Threading.Tasks.Task.FromResult(UpdatecompanyOption(cid, quotefortax, legelassessment, borrowing, agreement, uid, out procResult));
        }
        ...
        {
            int procResult;
            return System.Threading.Tasks.Task.FromResult(Updatetrust(id, name, type, setupDate, state, smsf, acn, abn, ptn, padd, lname, uid, smsfCompanyName, smsfAcn, smsfCompanySetupDate, propertyTrusteeDate, out procResult));
        }
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.List<UserloginReturnModel>> UserloginAsync(string email, string pass)
        {
            int procResult;
            return System.Threading.Tasks.Task.FromResult(Userlogin(email, pass, out procResult));
        }
    ...
    public class ShareDistributeGrid
    {
        ...
        public decimal? Totalshares { get; set; } // totalshares  change int -> decimal
        public decimal? Unitprice { get; set; } // unitprice
        public decimal? Totalprice { get; set; } // totalprice  change int -> decimal
    ...
    public class TblCompany
    {
        ...
        public string specialpurpose_ifapplicable { get; set; } //Special purpose
        public string isspecialpurpose { get; set; } // isspecialpurpose Company
    ...
    public class TblCompanyDirector
    {
        ...
        public string designation { get; set; } // designation  (director/ secretary)
    ...
    public class TblCompanyShare
    {
        ...
        public double? NoOfShare { get; set; } // NoOfShare
        ...
        public string shareoption { get; set; } //shareoption paid or unpaid
    ...
    public class TblTrust
    {
        ...
        public System.DateTime? ExistingSetupDate { get; set; }  // Existing Setup Date
        public string ClauseNumber { get; set; }  // Clause Number
    }
    ...
    public class TblUser
    {
        ...
        public bool? Del { get; set; } // Del
        public string Phone { get; set; } // Phone (length: 50)
        public long Regid { get; set; } // Reg no
        public string Tuser { get; set; } // Type of user 
    ...
    public class ShareDistributeGridConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ShareDistributeGrid>
    {
        ...
        public ShareDistributeGridConfiguration(string schema)
        {
            ...
            Property(x => x.Companyid).HasColumnName(@"companyid").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(50);
            Property(x => x.Shareclass).HasColumnName(@"shareclass").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(100);
            Property(x => x.Totalshares).HasColumnName(@"totalshares").HasColumnType("decimal").IsOptional();
            Property(x => x.Unitprice).HasColumnName(@"unitprice").HasColumnType("decimal").IsOptional().HasPrecision(18, 2);
            Property(x => x.Totalprice).HasColumnName(@"totalprice").HasColumnType("decimal").IsOptional().HasPrecision(18, 2);
            Property(x => x.CTotalshares).HasColumnName(@"c_totalshares").HasColumnType("decimal").IsOptional();
    ...
    public class TblCompanyShareConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<TblCompanyShare>
    {
        ...
        public TblCompanyShareConfiguration(string schema)
        {
            ...
            Property(x => x.NoOfShare).HasColumnName(@"NoOfShare").HasColumnType("float").IsOptional();
    ...
    public class GetShareAllocationMainPdfReturnModel
    {
        ...
        public System.Int32? totalshares { get; set; }
        public System.Decimal? unitprice { get; set; }
        public System.Decimal? totalprice { get; set; }
        public System.Int32? c_totalshares { get; set; }
    ...
    public class GetShareDistributegridReturnModel
    {
        ...
        public System.String companyid { get; set; }
        public System.String sno { get; set; }
        public System.Int32? pre_nos { get; set; }
        public System.String shareclass_c { get; set; }
        public System.String linkid { get; set; }
        public System.Int32? noofshares_c { get; set; }
